<h1>기존 쇼핑몰 db 수평 확장 적용</h1>

기존 쇼핑몰: https://github.com/kimtaehyun304/tama-api  

### 기술
스프링 부트3, data jpa, mysql 8.0.37
  
버전1 (로컬)
* cqrs로 패키지 분리, slave 로드 밸런싱
* 도커로 mysql 복제 환경 구축 master 1, slave 2

버전2 (수동 수평 확장)
* aws rds (mysql), route53

버전3 (자동 수평 확장)
* aws aurora (mysql), rds proxy 
...
버전2
 ...
 <ul>
  ...
  <li>왜나면 yml에서 db 주소를 프록시 서버로 해두면, 스케일 아웃하고 재배포 안해도 됨</li>
